{combine_css path="themes/csh/selectize.js/dist/css/selectize.bootstrap2.css"}
{combine_script id='jquery.selectize' load='footer' path="themes/csh/selectize.js/dist/js/standalone/selectize.min.js"}
{footer_script}
