                    ...
                    {if !$ALLOW_USER_CUSTOMIZATION}
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <input class="btn btn-default" type="submit" name="validate"
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="nb_image_page"
                               class="col-sm-2 control-label">{'Number of photos per page'|@translate}</label>
                        <div class="col-sm-1">
                            <input type="text" maxlength="3" name="nb_image_page" id="nb_image_page"
                                   class="form-control" value="{$NB_IMAGE_PAGE}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    {if $ACTIVATE_COMMENTS}
                        <div class="form-group">
                            <label for="show_nb_comments"
                                   class="col-sm-2 control-label">{'Show number of comments'|@translate}</label>
                            <div class="col-sm-10 html-radios-inline radio">
                    ...
                    {/if}
                    <div class="form-group">
                        <label for="show_nb_hits"
                               class="col-sm-2 control-label">{'Show number of hits'|@translate}</label>
                        <div class="col-sm-10 html-radios-inline radio">
