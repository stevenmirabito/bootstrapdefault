    ...
    {if $DISPLAY_NAV_BUTTONS or isset($slideshow)}
        {if isset($slideshow)}
            {if isset($slideshow.U_INC_PERIOD)}
                <a href="{$slideshow.U_INC_PERIOD}" title="{'Reduce diaporama speed'|@translate}"
                   class="pwg-state-default pwg-button">
                    <span class="glyphicon glyphicon-minus"></span><span
                            class="glyphicon-text">{'Reduce diaporama speed'|@translate}</span>
                </a>
            {else}
                <span class="glyphicon glyphicon-minus"></span>
                <span class="glyphicon-text">{'Reduce diaporama speed'|@translate}</span>
            {/if}
            {if isset($slideshow.U_DEC_PERIOD)}
                <a href="{$slideshow.U_DEC_PERIOD}" title="{'Accelerate diaporama speed'|@translate}"
                   class="pwg-state-default pwg-button">
                    <span class="glyphicon glyphicon-plus"></span><span
                            class="glyphicon-text">{'Accelerate diaporama speed'|@translate}</span>
                </a>
            {else}
                <span class="glyphicon glyphicon-plus"></span>
                <span class="glyphicon-text">{'Accelerate diaporama speed'|@translate}</span>
            {/if}
        {/if}
            ...
            <a href="{$slideshow.U_START_REPEAT}" title="{'Repeat the slideshow'|@translate}"
               class="pwg-state-default pwg-button">
                <span class="glyphicon glyphicon-repeat"></span><span
                        class="glyphicon-text">{'Repeat the slideshow'|@translate}</span>
            </a>
        {/if}
        ...
        {strip}{if isset($previous)}
            <a href="{$previous.U_IMG}" title="{'Previous'|@translate} : {$previous.TITLE_ESC}">
                <span class="glyphicon glyphicon-chevron-left"></span><span
                        class="glyphicon-text">{'Previous'|@translate}</span>
            </a>
        {else}
            <span class="glyphicon glyphicon-chevron-left"></span>
            <span class="glyphicon-text">{'Previous'|@translate}</span>
        {/if}{/strip}
        ...
        {if isset($slideshow.U_STOP_PLAY)}
            <a href="{$slideshow.U_STOP_PLAY}" title="{'Pause of slideshow'|@translate}">
                <span class="glyphicon glyphicon-pause"></span><span
                        class="glyphicon-text">{'Pause of slideshow'|@translate}</span>
            </a>
        {/if}
        {if isset($U_SLIDESHOW_STOP) }
            <a href="{$U_SLIDESHOW_STOP}" title="{'stop the slideshow'|@translate}">
                <span class="glyphicon glyphicon-stop"></span><span
                        class="glyphicon-text">{'stop the slideshow'|@translate}</span>
            </a>
        {/if}
        {strip}{if isset($next)}
            <a href="{$next.U_IMG}" title="{'Next'|@translate} : {$next.TITLE_ESC}">
                <span class="glyphicon glyphicon-chevron-right"></span><span
                        class="glyphicon-text">{'Next'|@translate}</span>
            </a>
        {else}
            <span class="glyphicon glyphicon-chevron-right"></span>
            <span class="glyphicon-text">{'Next'|@translate}</span>
        {/if}{/strip}
        {*<!--{strip}{if isset($last)}
